...
<body>
    ...
    <div class="viewer-wrap">
        <model-viewer
            id="viewer"
            src="{{ asset('storage/models/cake_4in_layers2_v13.glb') }}"
            ios-src="{{ asset('storage/models/cake_4in_layers2_v13.usdz') }}"
            alt="{{ $cake->name }}"
            ar
    ...
    <script>
        ...
        const MODEL_VERSION = "v13"; // غيّر هذا الرقم كل مرة تحدّث ملفات النماذج — جزء من اسم الملف نفسه
